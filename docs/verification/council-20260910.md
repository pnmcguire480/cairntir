...
Status: local candidate verification passed; hosted verification is pending.
...
All 1,743 collected cases passed across the normal, permission-rerun, new
boundary, model and slow selections. The initial full run had four sandbox
permission failures; those four passed with network/process permissions. The
final combined coverage was 92.045257% with unchanged exclusions, including
